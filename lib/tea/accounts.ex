defmodule Tea.Accounts do
  ...
  alias Tea.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Tea.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Tea.Accounts.User.password_changeset/3` for a list of supported options.
  ...
  ## Examples
      ...
      iex> deliver_user_update_email_instructions(user, current_email, &url("/example-confirm-email/#{&1}"))
      {:ok, %{to: ..., body: ...}}
