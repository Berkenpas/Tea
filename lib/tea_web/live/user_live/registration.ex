        ...
        <section class="auth-panel">
          <div class="auth-panel__heading">
            <.header>
              Create your account
              <:subtitle>
                Tea uses Google sign-in so you do not need to wait for an email confirmation link.
              </:subtitle>
            </.header>
          </div>

          <.link href={~p"/users/auth/google"} class="button button--google" id="google-register-link">
          ...
          <p class="auth-panel__footnote">
            Already registered? Use the same Google button on the <.link
